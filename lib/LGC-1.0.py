...
'''
This the product of the work by Guangyu Wang, Hongyan Yin, 
	Boyang Li, Chunlei Yu, Fan Wang, Xingjian Xu, Jiabao Cao, Yiming Bao, 
	Liguo Wang, Amir A Abbasi, Vladimir B Bajic, Lina Ma and Zhang Zhang.
Published as part of the article "Characterization and identification 
	of long non-coding RNAs based on feature relationship", 
	https://doi.org/10.1093/bioinformatics/btz008.
Script downloaded from https://bigd.big.ac.cn/lgc/calculator.
'''
